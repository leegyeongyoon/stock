...
import { getTradeHistory, getStrategies } from "@/lib/api";
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
        ...
        <div className="bg-slate-800 rounded-lg border border-slate-700 p-3 text-center">
          ...
          <p className={`text-lg font-bold font-mono ${pnlColor(winRate - 50)}`}>
            {winRate.toFixed(1)}%
          </p>
        </div>
        <div className="bg-slate-800 rounded-lg border border-slate-700 p-3 text-center">
        ...
        <div className="bg-slate-800 rounded-lg border border-slate-700 p-3 text-center">
          ...
          <p className={`text-lg font-bold font-mono ${pnlColor(avgPnl)}`}>
            {avgPnl >= 0 ? "+" : ""}
