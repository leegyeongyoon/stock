    ...
    try:
        ...
        algorithm = {
            ...
            "backtest_verified": {
                ...
                "best_filter": "시총 5000억+ & 전일 기관 50~200억",
                "results": {
                    "전체": "255건 WR 56.1% 합계 +76.60%",
                    "돌파만": "204건 WR 59.3% 합계 +84.32%",
                    "눌림만": "51건 WR 43.1% 합계 -7.72%",
                },
                "comparison": {
                    "무필터": "250건 WR 42.0% -151.41%",
                    "시총5000억+": "298건 WR 51.7% +14.89%",
                    "시총5000억+기관순매수>0": "309건 WR 53.1% +58.22%",
                    "시총5000억+기관50~200억": "255건 WR 56.1% +76.60%",
                },
            },
            "avoid_rules": [
...
STRATEGY_GUIDE_SECTIONS = [
    ...
    },
    {
        ...
        "rules": [
            ...
            {"importance": "핵심", "rule": "눌림 매매 (조건 개선 필요)", "detail": "상승 후 되돌림 시 지지선에서 진입. 20일 검증 결과 모든 필터 조합에서 소폭 마이너스(-5~-14%). 눌림 조건 추가 개선 필요. 오후 13~14:30시."},
